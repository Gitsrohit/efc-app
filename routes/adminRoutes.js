...
//create routes
//health api
router.get('/health',companyMiddleware, healthCheck);
...
router.post("/generate-pdf", companyMiddleware, generateBillsSummaryPdf)
router.post("/generate-alt-pdf", companyMiddleware, generateFakeBillsSummaryPdf)
...
router.delete('/delete-customers/:id', companyMiddleware, deleteCustomer);
...
router.post(
  ...
  router.get('/search-items', companyMiddleware, searchCategoryItems);
